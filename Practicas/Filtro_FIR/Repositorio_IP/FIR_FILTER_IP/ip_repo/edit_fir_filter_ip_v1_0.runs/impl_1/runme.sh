...
HD_PWD='c:/users/juanma/documents/juanma/cese/mys/practicas/filtro_fir/repositorio_ip/fir_filter_ip/ip_repo/edit_fir_filter_ip_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filter_ip_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_filter_ip_v1_0.tcl -notrace
