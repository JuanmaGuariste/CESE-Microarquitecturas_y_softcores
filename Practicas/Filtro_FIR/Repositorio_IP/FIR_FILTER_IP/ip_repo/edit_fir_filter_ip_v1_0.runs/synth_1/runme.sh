...
HD_PWD='c:/users/juanma/documents/juanma/cese/mys/practicas/filtro_fir/repositorio_ip/fir_filter_ip/ip_repo/edit_fir_filter_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filter_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_filter_ip_v1_0.tcl
