...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins buttons/gpio_io_i] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins switches/gpio_io_i] [get_bd_pins vio_0/probe_out1]
