...
HD_PWD='c:/users/juanma/documents/fir_filter/repos_ip/genena_ip/managed_ip_project/managed_ip_project.tmp/genEna_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log genEna.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source genEna.tcl
