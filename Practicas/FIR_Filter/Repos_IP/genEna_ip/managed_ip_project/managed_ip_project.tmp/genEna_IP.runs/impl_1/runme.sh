...
HD_PWD='c:/users/juanma/documents/fir_filter/repos_ip/genena_ip/managed_ip_project/managed_ip_project.tmp/genEna_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log genEna.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source genEna.tcl -notrace
