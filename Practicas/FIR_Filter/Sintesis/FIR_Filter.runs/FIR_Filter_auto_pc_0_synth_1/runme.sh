...
HD_PWD='C:/Users/Juanma/Documents/FIR_Filter/Sintesis/FIR_Filter.runs/FIR_Filter_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Filter_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_Filter_auto_pc_0.tcl
