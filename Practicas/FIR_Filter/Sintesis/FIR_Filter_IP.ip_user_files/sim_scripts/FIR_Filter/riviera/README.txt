...
#
# Generated by export_simulation on Sat Jun 14 14:39:24 -0300 2025
#
################################################################################
...
'-reset_run' switch to the './FIR_Filter.sh' script.

./FIR_Filter.sh -reset_run
...
./FIR_Filter.sh -noclean_files

For more information on the script, please type './FIR_Filter.sh -help'.
