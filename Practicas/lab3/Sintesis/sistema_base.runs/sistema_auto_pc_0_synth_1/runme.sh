...
HD_PWD='C:/Users/Juanma/Documents/Juanma/CESE/MyS/Practicas/lab3/Sintesis/sistema_base.runs/sistema_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_auto_pc_0.tcl
