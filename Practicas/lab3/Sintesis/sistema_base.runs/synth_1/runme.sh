...
HD_PWD='C:/Users/Juanma/Documents/Juanma/CESE/MyS/Practicas/lab3/Sintesis/sistema_base.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_wrapper.tcl
