...
HD_PWD='C:/Users/Juanma/Documents/Juanma/CESE/MyS/Practicas/lab3/Sintesis/sistema_base.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_wrapper.tcl -notrace
